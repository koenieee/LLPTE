...
* Prefix:   Role-play
* Datetime: 04_11_2024__22:00:25
* UniqueID: 531887fb-1bed-472f-b476-d9b038307c90
...
## Rimay Output
```
1. UserA must be "logged in" as "john@example.com"
2. UserA views "order history"
3. UserA must see "one order" with total of "$29.99"
``` 
